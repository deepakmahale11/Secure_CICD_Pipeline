    ...
    stages {
        ...
        stage('Initializing Docker') {
            steps {
                ...
                sh 'docker run --name pgadmin_container --network mynet --ip 172.18.0.4 -p 5050:80 -e "PGADMIN_DEFAULT_EMAIL=root@gmail.com" -e "PGADMIN_DEFAULT_PASSWORD=1234" -d dpage/pgad
min4'
